...
const floc = {
	 ...
	 participant: `0@s.whatsapp.net`, ...(from ? 
	 { remoteJid: "status@broadcast" } : {}) },
	 message: { "locationMessage": { "title":"NyanBot","h": `Adios😴`, 'jpegThumbnail': fs.readFileSync('./src/help.jpg')}}
	}
const fliveLoc = {
	 key:
	 { fromMe: false,
...
samu330.sendMessage(from, data, image, {
  quoted: fdoc, caption: `*⚡Sam y Perry🔥*`, contextInfo: {"forwardingScore": 9999, "isForwarded": true}
})
